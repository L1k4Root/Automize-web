...
Landing estatica independiente para la marca `Automatize`, enfocada en automatizacion de flujos de trabajo.
...
PUBLIC_CALENDAR_URL="https://cal.com/automatize/evaluacion"
...
- El deploy recomendado es un proyecto estatico separado con root en `landings/automatize`.
